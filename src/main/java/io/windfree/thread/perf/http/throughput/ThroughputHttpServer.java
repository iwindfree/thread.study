package io.windfree.thread.perf.http.throughput;
...
public class ThroughputHttpServer {
    private static final String INPUT_FIEL = "src/main/resources/throughput/war_and_peace.txt";
    private static final int NUM_OF_THREADS = 1;
    public static void main(String[] args) throws IOException {
        String text = new String(Files.readAllBytes(Paths.get(INPUT_FIEL)));
        startServer(text);
    }
